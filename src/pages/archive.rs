                    ...
                    .map(|filename| {
                        ...
                        html! { 
                            <Link<Route> classes={classes!("post-preview")} to={Route::Page { class: "archive".to_string(), filename: filename.to_string() }}>
                                <Preview class={"archive".to_string()} filename={filename.clone()} tag_cb={tag_cb.clone()} selected_tag={"".to_string()}/>
                            </Link<Route>>
                        }
                    })
                    .collect();
                ...
                self.preview = preview;
                    ...
                    let preview: Vec<Html> = self.list
                        ...
                        .map(|filename| {
                            ...
                            html! { 
                                <Link<Route> classes={classes!("post-preview")} to={Route::Page { class: "archive".to_string(), filename: filename.to_string() }}>
                                    <Preview class={"archive".to_string()} filename={filename.clone()} tag_cb={tag_cb.clone()} selected_tag={tag.clone()}/>
                                </Link<Route>>
                            }
                        })
                        .collect();
